...
const sections = [
  ...
  },
  {
    ...
    content: (
      <List>
        <ListItem>
          <ListItemText primary="Odisha University of Technology and Research" secondary="B.Tech in Information Technology, 2020 - 2024, CGPA: 9.23" />
        </ListItem>
      </List>
    ),
  },
  {
    ...
    content: (
      <List>
        <ListItem>
          <ListItemText
            primary="Web Developer Intern at Meliorist Developers (APRIL 2023 - JULY 2023.)"
            secondary={
              <>
                <ul>
                  <li>Responsible for development and maintenance of the website and ERP platform of Youstad. (https://youstad.com)</li>
                  <li>Utilized React framework for developing and Material UI for styling the platform websites.</li>
                  <li>Integrated APIs and authentication using AWS Amplify libraries and implemented state management using React hooks.</li>
            ...
            secondary={
              <>
                <ul>
                  ...
                  <li>Incorporated the Stripe API to facilitate secure and seamless payment processing, enhancing the platform's credibility and user-friendliness.</li>
            ...
            secondary={
              <>
                <ul>
                  ...
                  <li>Employed the power of Redux for meticulous state management, enabling real-time data updates and maintenance throughout the app.</li>
                </ul>
              </>
            } 
          />
      ...
      <Box sx={{marginTop:"10px"}}>
        {skills.map((skill) => (
          <Box key={skill.name} marginBottom={2}>
            ...
            <LinearProgress variant="determinate" value={skill.level} className="linear-progress" />
          </Box>
        ))}
      </Box>
    ),
    ...
    content: (
      <List>
        <ListItem sx={{ display: "flex", flexDirection: "column", alignItems: "flex-start" }}>
          <ListItemText primary="Salesforce Developer Virtual Internship" />
          ...
          <ListItemText primary="Introduction to C++" />
...
const App = () => {
  return (
    <Container>
      ...
      <footer>
        <Typography variant="h6" style={{margin:"20px 0 15px 0"}}>
          Contact 
        </Typography>
        <div className="footer-links">
          <a href="mailto:ansumansenapati10@gmail.com"  style={{ marginRight: "20px" }}><EmailIcon style={{ fontSize: 40}}/></a>
